SELECT a.LOGIN_ID, a.LOGIN, a.STATUS, me.LAST_NAME, me.FIRST_NAME, me.SECOND_NAME, me.SNILS, me.PHONE, me.EMAIL, omk.NAME as REGION_NAME, ds.NAME as SPEC_NAME, ds.CODE as SPEC_CODE, ur.USER_ROLE, ur.ID AS USER_ROLE_ID, l.id as LPU_ID, l.name as LPU_NAME, l.OGRN, l2.ID as MO_ID, l2.NAME as MO_NAME, l2.OGRN as MO_OGRN
...
WHERE (meji.JOB_START_DATE < sysdate) AND (meji.JOB_END_DATE > sysdate OR meji.JOB_END_DATE IS NULL) AND a.STATUS='ACTIVE' AND (abs.STATUS = 'ACTIVE' OR abs.STATUS IS NULL)
UNION
SELECT a.LOGIN_ID, a.LOGIN, a.STATUS, me.LAST_NAME, me.FIRST_NAME, me.SECOND_NAME, me.SNILS, me.PHONE, me.EMAIL, omk.NAME as REGION_NAME, ds.NAME as SPEC_NAME, ds.CODE as SPEC_CODE, ur.USER_ROLE, ur.ID AS USER_ROLE_ID, l.id as LPU_ID, l.name as LPU_NAME, l.OGRN, l2.ID as MO_ID, l2.NAME as MO_NAME, l2.OGRN as MO_OGRN
FROM emias_cluster.MEDICAL_EMPLOYEE me
         JOIN emias_cluster.MEDICAL_EMPLOYEE_JOB_INFO meji ON me.id = meji.MEDICAL_EMPLOYEE_ID
